;;;; csp/package.lisp -- Package definition for phd-research CSP solver
...
;; Data lists (defparameter'd later but referenced earlier in load order)
...
;; Bare setq locals in legacy code (bm.lisp, bt.lisp, queens.lisp)
(defvar lowunit nil)
(defvar mark nil)
