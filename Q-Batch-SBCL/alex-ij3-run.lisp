;;;; alex-ij3-run.lisp -- Parametric ij3 (memory-search + FC/DR/advance-sort) for alex
;;;;
;;;; Usage: sbcl --non-interactive --eval '(defvar *alex-noise* 50)' \
;;;;        --load "Q-Batch-SBCL/alex-ij3-run.lisp"
...
(let* ((noise *alex-noise*)
  ...
  (format t "~&;; alex-ij3: noise=~A~%" noise)

  (loop for seed in seeds
        for suffix in suffixes
        for outfile = (format nil "../Q-Batch-SBCL/alex-ij3/ij3-~A.~A" noise-str suffix)
