;;;; may29-ij2-run.lisp -- Parametric ij2 (memory-search baseline) for may29
;;;;
;;;; Usage: sbcl --non-interactive --eval '(defvar *may29-noise* 50)' \
;;;;        --load "Q-Batch-SBCL/may29-ij2-run.lisp"
...
(let* ((noise *may29-noise*)
  ...
  (format t "~&;; may29-ij2: noise=~A~%" noise)

  (loop for seed in seeds
        for suffix in suffixes
        for outfile = (format nil "../Q-Batch-SBCL/may29-ij2/ij2-~A.~A" noise-str suffix)
