# Compare ij3 (memory-search + FC/DR/advance-sort) -- ACL vs SBCL
# Usage: gnuplot compare-ij3-ci.gp   (from project root)
...
set output "Q-Batch-SBCL/Graph/compare-ij3-ci.pdf"
