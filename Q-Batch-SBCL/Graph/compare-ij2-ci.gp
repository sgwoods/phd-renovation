...
plot \
  "data/acl-experiments/Graph/ij2-ci.dat" using 1:2:3:4 title "ACL (original)" with yerrorbars lc rgb "#0000AA" pt 5 ps 0.8, \
  "data/acl-experiments/Graph/ij2-ci.dat" using 1:2 notitle with lines lc rgb "#0000AA" lw 1.5, \
