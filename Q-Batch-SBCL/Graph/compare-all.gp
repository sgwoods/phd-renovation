...
plot \
  "data/acl-experiments/Graph/ij2-ci.dat" using 1:2 title "ACL ij2 (mem-BT+FCDR)" with linespoints lc rgb "#0000AA" dt 2 pt 4 ps 0.6, \
  "Q-Batch-SBCL/Graph/ij2-ci.dat" using 1:2 title "SBCL ij2 (mem-BT+FCDR)" with linespoints lc rgb "#0000AA" pt 5 ps 0.6 lw 1.5, \
  "data/acl-experiments/Graph/ij3-ci.dat" using 1:2 title "ACL ij3 (mem-both FCDR)" with linespoints lc rgb "#CC0000" dt 2 pt 8 ps 0.6, \
  "Q-Batch-SBCL/Graph/ij3-ci.dat" using 1:2 title "SBCL ij3 (mem-both FCDR)" with linespoints lc rgb "#CC0000" pt 9 ps 0.6 lw 1.5, \
  "data/acl-experiments/Graph/ij4-ci.dat" using 1:2 title "ACL ij4 (direct FCDR)" with linespoints lc rgb "#008800" dt 2 pt 6 ps 0.6, \
