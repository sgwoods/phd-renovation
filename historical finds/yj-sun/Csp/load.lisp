...
(defun loadit-lisp ()
  (progn
      ...
      ;; load MPR domain
      ;;(load "mpr-simple.lisp")   ;; functionality
      ;;(load "mpr-setup.lisp")    ;; template, situation information

      ;; load ADT domain
      (load "quilici-search.lisp") 
      (load "adt-simple.lisp")   ;; functionality
      (load "adt-setup.lisp")    ;; template, situation information
