 ...
 (list
  ...
  '("leap-year-21-25"
   ...
   (
     ...
     (e2 (Mul Id2-1 Id2-2 Id2-3))         ;temp2 = cc * 100
     ...
     (e6 (Mul Id6-1 Id6-2 Id6-3))         ;temp5 = q * 4
     ...
     (e10 (Mul Id10-1 Id10-2 Id10-3))     ;temp8 = q * 400
     (e11 (Minus Id11-1 Id11-2 Id11-3))   ;temp9 = year - temp8
     (e12 (Assign Id12-1 Id12-2))         ;r2 = temp9

     (e13 (Test))                         ;
     (e14 (EqEq Id14-1 Id14-2 Id14-3))    ;r1 == 0
     (e15 (Test))                         ;
     (e16 (EqEq Id16-1 Id16-2 Id16-3))    ;yy == 0
     (e17 (Test))
     (e18 (EqEq Id18-1 Id18-2 Id18-3))    ;r2 == 0
     )
    (
     ...
     (guaranteed-data-dependency (e10 e1) Id10-2)
     (guaranteed-data-dependency (e10 e90) Id10-1)
     (guaranteed-data-dependency (e11 e10) Id11-1)
  ...
  '("new-traverse-string-6-9"
    (
     ...
     (e6 (PostInc Id6-1))                ;update: i++
     )
    (
     (control-data-dependency (e2 e1))          ;initbef
     (possible-data-dependency (e3 e1) Id3-1)   ;acc1bef
