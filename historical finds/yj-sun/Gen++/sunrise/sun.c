...
int day;
int yr;
int tz=10;			/* Default time zone */
/* int tz=8;			/* Default time zone */
char *tzs = "(HST)";		/* Default time zone string */
/* char *tzs = "(PST)";		/* Default time zone string */
char *dtzs = "(HST)";		/* Default daylight savings time string */
/* char *dtzs = "(PDT)";		/* Default daylight savings time string */
int popt = 0;
int milflag = 0;		/* military time flag 	r.f. */

double lat = 21.251666;		/* Default latitude (Honolulu at DiamondHead) */
double lon = 157.811666;	/* Default Longitude (Degrees west) */ 
/* double lat = 21.151;		/* Default latitude (Honolulu at DiamondHead) */
/* double lon = 157.487;		/* Default Longitude (Degrees west) */ 
