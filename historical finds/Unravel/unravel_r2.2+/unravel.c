	...
	char	*p[];
{
	...
	fprintf (stdout,"TEST OUTPUT 0 in unravel.c sgw\n");
	...
	fprintf (stdout,"TEST OUTPUT 1 in unravel.c sgw\n");
	...
	fprintf (stdout,"TEST OUTPUT 2 in unravel.c sgw\n");
	...
	fprintf (stdout,"TEST OUTPUT 3 in unravel.c sgw\n");

	sprintf (cmd,"echo -n UNRAVEL \" %s \" >> HISTORY ; date >>HISTORY",
		getcwd (NULL,2000));

	fprintf (stdout,"TEST OUTPUT 4 in unravel.c sgw\n");

	system(cmd);

	fprintf (stdout,"TEST OUTPUT 5 in unravel.c sgw\n");

	system ("echo \"No slices computed this session\" >HISTORY-S");
	system ("echo \"No analysis done this session\" >HISTORY-A");

	fprintf (stdout,"TEST OUTPUT 6 in unravel.c sgw\n");

	make_windows(top);

	fprintf (stdout,"TEST OUTPUT 7 in unravel.c sgw\n");

	XtAppMainLoop(ac);

	fprintf (stdout,"TEST OUTPUT 8 in unravel.c sgw\n");
}
