	...
	Widget  x;
{
	...
	fprintf (stdout,"TEST OUTPUT do_slice in u.c  0 sgw\n");
	...
	MultiSliceReturn *r;
{
	...
	fprintf (stdout,"TEST OUTPUT in slicecall from in u.c  0 sgw\n");
	...
	caddr_t	y;
{
	...
	fprintf (stdout,"TEST OUTPUT in clearB from in u.c  0 sgw\n");

	sprintf (buff,"Yource text for: %sc",state->root_file); 
    ...
    char **argv;
{
	...
	fprintf (stdout,"TEST OUTPUT main in u.c  0 sgw\n");
	...
	char	*file_name;
{
	...
	*/
	...
	fprintf (stdout,"TEST OUTPUT in create_widgets from in u.c  0 sgw\n");

	/*	sprintf (buff,"Source text for: %sc",ps.root_file); */
	sprintf (buff,"Xource text for: %sc",ps.root_file); 
