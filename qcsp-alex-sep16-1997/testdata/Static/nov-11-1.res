...
@    legend linewidth 1
@    legend color 1
@    legend string 0 "alloc-array-4-3"
@    legend string 1 "averagearray-8-12"
@    legend string 2 "increment-2-2"
@    legend string 3 "reset-value-2-1"
@    frame on
@    frame type 0
@    frame linestyle 1
@    frame linewidth 1
