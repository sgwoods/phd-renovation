...
(time (adt 
	   ...
	   :output-file "New-Batch/H-fcdr-dist3-4000.1"
	   ))
...
(time (adt 
	   ...
	   :output-file "New-Batch/H-fcdr-dist3-4000.2"
	   ))
...
(time (adt 
	   ...
	   :output-file "New-Batch/H-fcdr-dist3-4000.3"
	   ))
...
(time (adt 
	   ...
	   :output-file "New-Batch/H-fcdr-dist3-4000.4"
	   ))
...
(time (adt 
	   ...
	   :output-file "New-Batch/H-fcdr-dist3-4000.5"
	   ))
...
(time (adt 
	   ...
	   :output-file "New-Batch/H-fcdr-dist3-4000.6"
	   ))
...
(time (adt 
	   ...
	   :output-file "New-Batch/H-fcdr-dist3-4000.7"
	   ))
...
(time (adt 
	   ...
	   :output-file "New-Batch/H-fcdr-dist3-4000.8"
	   ))
...
(time (adt 
	   ...
	   :output-file "New-Batch/H-fcdr-dist3-4000.9"
	   ))
