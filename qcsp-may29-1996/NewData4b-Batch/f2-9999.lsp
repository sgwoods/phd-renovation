...
(time (adt 
	...
	:template-id  "quilici-t1"
	   ...
	   :output-file "New-Batch/fcdr-dist2-9999.2"
	   ))
...
(time (adt 
	...
	:template-id  "quilici-t1"
	   ...
	   :output-file "New-Batch/fcdr-dist2-9999.3"
	   ))
...
(time (adt 
	...
	:template-id  "quilici-t1"
	   ...
	   :output-file "New-Batch/fcdr-dist2-9999.4"
	   ))
...
(time (adt 
	...
	:template-id  "quilici-t1"
	   ...
	   :output-file "New-Batch/fcdr-dist2-9999.5"
	   ))
...
(time (adt 
	...
	:template-id  "quilici-t1"
	   ...
	   :output-file "New-Batch/fcdr-dist2-9999.6"
	   ))
...
(time (adt 
	...
	:template-id  "quilici-t1"
	   ...
	   :output-file "New-Batch/fcdr-dist2-9999.7"
	   ))
...
(time (adt 
	...
	:template-id  "quilici-t1"
	   ...
	   :output-file "New-Batch/fcdr-dist2-9999.8"
	   ))
...
(time (adt 
	...
	:template-id  "quilici-t1"
	   ...
	   :output-file "New-Batch/fcdr-dist2-9999.9"
	   ))
...
(time (adt 
	...
	:template-id  "quilici-t1"
	   ...
	   :output-file "New-Batch/fcdr-dist2-9999.99"
	   ))
:exit
