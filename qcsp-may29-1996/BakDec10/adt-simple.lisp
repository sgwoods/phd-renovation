...
(if (not (adt-set-global-values 
	  situation-id sit-noise            random-ident 
	  template-id  rand-dist            (get-dist rand-dist)
	  long-output  single-line-override suppress-single-line
	  ))
...
;;  not appropriate at moment for ADT
      (save-situation random-ident sit-noise)   ;; storage of situation & ids
