...
(defun load-simple ()
	(load "example-orig.lisp"))

;;(defun load-simple ()
;;	(load "Macintosh HD:Languages:Allegro Common Lisp:qcsp:example-orig.lisp"))
...
(setf (DomVal-LeftChild       Q4)  nil)
(setf (DomVal-LeftChildType   Q4)  nil)
(setf (DomVal-RightChild      Q4)  P1)
(setf (DomVal-RightChildType  Q4)  'or)
