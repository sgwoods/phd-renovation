...
(defun load-extend (&optional (sys *unix*) )
  (if sys
   ...
   (load "Macintosh HD:Languages:Allegro Common Lisp:qcsp:example-extend.lisp")
    ))
...
(setq V0 (make-CVariable :name 'V0 :DomainValueList (list E1 E2)    ))
(setq V1 (make-CVariable :name 'V1 :DomainValueList (list A1 A2 A3) ))
(setq V2 (make-CVariable :name 'V2 :DomainValueList (list B1 B2 B3) ))
